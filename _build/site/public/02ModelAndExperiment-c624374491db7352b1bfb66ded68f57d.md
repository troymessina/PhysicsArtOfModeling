...
:::{tip} Checkpoint
In Chlo$\"e$'s theory of falling objects from [](#chap:introduction), the time, $t$, for an object to fall a distance, $x$, was given by $t=k\sqrt{x}$. What must the SI units of Chlo\"e's constant, $k$, be?}
1.  \si{T.L^{\frac{1}{2}}}
2.  \si{T.L^{-\frac{1}{2}}}
3.  \si{s.m^{\frac{1}{2}}}
4.  \si{s.m^{-\frac{1}{2}}} 
