...
\captionof{table}{:label: tab:Calculus:commondersCommon derivatives of functions.}
\end{center}
...
\captionof{table}{:label: tab:Calculus:combdersDerivatives of combined functions.}
\end{center}
:::{note} Example
