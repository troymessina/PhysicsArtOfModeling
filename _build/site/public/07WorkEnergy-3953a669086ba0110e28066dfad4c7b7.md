...
:::{note} Solution
:class: dropdown
This is the same problem that we presented in [Section %s](#sec:applyingnewtonslaws:modellingwhereforcechanges) in [Example 6.](#ex:applyingnewtonslaws:blockspring), where we solved a differential equation to find the speed. 
