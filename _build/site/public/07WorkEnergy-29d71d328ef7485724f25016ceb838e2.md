...
:::{note} Solution
:class: dropdown
This is the same problem that we presented in [Chapter %s](#chap:ApplyingNewtonsLaws) in [](#ex:applyingnewtonslaws:blockspring), where we solved a differential equation to find the speed. 
