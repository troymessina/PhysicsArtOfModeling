...
```{math}
E_x &= \int k\frac{dq}{r^2}\cos\theta\\
E_x &= k\int_{-\theta_0}^{\theta_0} \lambda\frac{R}{\cos^2\theta} \frac{\cos^2\theta}{R^2} \cos\theta d\theta=\frac{k\lambda}{R}\int_{-\theta_0}^{\theta_0}\cos\theta d\theta=\frac{k\lambda}{R}\left${\rm \left[n\theta \right\right]}$_{-\theta_0}^{\theta_0}\\
E_x &= \frac{2k\lambda}{R}\sin\theta_0
```
