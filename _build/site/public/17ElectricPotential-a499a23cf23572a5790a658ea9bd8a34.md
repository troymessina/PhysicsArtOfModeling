...
```{math}
\Delta E &= q\Delta V\\
1 {\rm eV}&=(e)(1 {\rm V})=1.6e-19 {\rm J}
```
An electron that has accelerated from rest across a region with a $150 {\rm V}$ potential difference across it will have a kinetic of $150 {\rm eV}=2.4e-17 {\rm J}$. As you can see, it is easier to describe the energy of an electron in electron volts than Joules.
...
```{math}
V(\vec r)=\frac{kQ}{r}=\frac{(9e9 {\rm N\cdot m^2/C^{2}})(1.6e-19 {\rm C})}{(1e-10 {\rm m})}=14.4 {\rm V}
```
...
```{math}
U=(-e)V=(-1.6e-19 {\rm C})(14.4 {\rm V})=-14.4 {\rm eV}=-2.3e-18 {\rm J}
```
...
```{math}
W=\Delta U=(U_{final}-U_{initial})=(0 {\rm J}--2.3e-18 {\rm J})=2.3e-18 {\rm J}
```
The positive work that we must do, exerting a force that is opposite to the electric force, is positive and equal to $2.3e-18 {\rm J}$, or $14.4 {\rm eV}$. If you look up the ionization energy of hydrogen, you will find that it is $13.6 {\rm eV}$, so that this very simplistic model is quite accurate (we could improve the model by adjusting the proton-electron distance so that the potential is $13.6 {\rm V}$). 
...
\therefore \lambda &= \frac{2\pi\epsilon_0\Delta V}{\ln\left(\frac{r_A}{r_B}\right)}=\frac{2\pi(8.85e-12 {\rm C^2\cdot N^{-1}\cdot m^{-2}})(-100 {\rm V})}{\ln\left(\frac{1}{2}\right)}=8.02e-9 {\rm C/m}
```
