...
(sec:gauss:interpretation)=
# Interpretation of Gauss' law and vector calculus
...
## Problems
:::{note} Problem 16.1
:label: prob:gauss:chargedsphere 
...
:::{note} Problem 16.2
:label: prob:gauss:coaxial_triangle 
...
[^42]:Since charges can freely move in a conductor, they will move until there is no reason to move. Eventually, the charges accumulate in such a way that the net field in the conductor is zero. For a plane, this means that half of the charges will move to each side, as illustrated.