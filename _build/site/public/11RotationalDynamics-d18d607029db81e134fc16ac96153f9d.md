...
\begin{align*}
\sum_k \vec\tau_{ik} = \vec\tau_i_{net} &= m_ir_i^2\vec\alpha_i
\end{align*}
...
\begin{align*}
\vec\tau_1_{net} + \vec\tau_2_{net} +\vec\tau_3_{net} + \dots &= m_1r_1^2\vec\alpha_1 + m_2r_2^2\vec\alpha_2 +m_3r_3^2\vec\alpha_3 +\dots\\
\sum_i \pvec\tau_i_{net} &= \sum_i  m_ir_i^2\vec\alpha_i
\end{align*}
