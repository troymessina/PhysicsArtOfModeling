...
:::{note} Example 4.1
In the graph below, an object moves for ten seconds with varying velocities. Describe the motion vs. time. Make sure to include direction of the motion.
...
:::{note} Solution
:class: dropdown
There are four different velocities, labeled a, b, c, d. During interval **a** from $t = 0$ to $t = 2$ seconds, the object moves from $x = 0$ to $x = 6$ meters, for a positive velocity in the $x$-direction of $\vec{v} = (6-0)/(2-0) = 3.00 m/s$. During interval **b** from $t = 2$ to $t = 5$ seconds, the object moves from $x = 6$ to $x = 2$ meters, for a negative velocity in the $x$-direction of $\vec{v} = (2-6)/(5-2) = 1.33 m/s$.
