...
:::{note} Think About It
You are sailing, and the wind is blowing from the north. You want to travel upwind (north). In what direction should you point your boat/sail?```{figure} figures/FluidMechanics/sailboat.png:label: fig:fluidmechanics:sailboat:width: 40%:align: center:alt: Possible directions you can point your sailboat.Possible directions you can point your sailboat.```}
1.  North
2.  South
