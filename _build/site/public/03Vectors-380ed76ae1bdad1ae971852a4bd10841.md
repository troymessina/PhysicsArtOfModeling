...
r1 = vector(1, 2, 3)
```
This could be an indication of the position of the object relative to an origin `O = vec(0,0,0)`. We draw a vector using the `arrow` object and give it the name`arw1` pointing to this position
```python
r1 = vec(1, 2, 3)
