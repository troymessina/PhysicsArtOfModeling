...
A resistor is measured to have a resistance of $R_1=103.4 {\rm \ohm}$ at a temperature of $T_1=30 {\rm \degree C}$, and a resistance of $R_2=106.8 {\rm \ohm}$ at a temperature of $T_2=40 {\rm \degree C}$. Using the values in [](#tab:current:materials), determine the material from which the resistor is made.
:::
