...
:::{note} Think About It
Two waves travel down two identical strings ([](#fig:waves:opening)). The frequency of the first wave is twice that of the second wave. Which wave will be faster?```{figure} figures/Waves/wavevel.png:label: fig:waves:opening:width: 30%:align: center:alt: Two waves travelling down two identical strings.Two waves travelling down two identical strings.```}
1.  The first wave.
2.  The second wave.
