...
:::{tip} Checkpoint{}
	...
	What speed, $v$, corresponds to a gamma factor of 2.5 {\rm }?}
1.  $v=2.5c$
2.  $v=0.92c$ 
3.  $v=0.25c$
4.  $v=0.47c$
...
:::{note} Example
:label: ex:specialrelativity:alphatripA spaceship carrying your friend Alice speeds away at a speed of $0.99c$ towards the nearest star, Proxima Centauri, a distance of $4.2 {\rm ly}$ (light-years) away. How much time does the trip take as measured by Alice? How far has the spaceship travelled, according to Alice?}
...
:width: 60%
:align: center
:alt: Alice travels in a spaceship from the Earth to the star Proxima Centauri. In the Earth frame of reference, the star is $\SI{4.2
Alice travels in a spaceship from the Earth to the star Proxima Centauri. In the Earth frame of reference, the star is $\SI{4.2
```{ly}$ away. }
...
:::
:::{tip} Checkpoint{}
	At what speed must an object travel in order for it to appear 1 {\rm \percent} shorter?}
1.  $0.01c$
2.  $0.04c$ 
3.  $0.99c$
4.  $0.65c$
...
If the charge, $+Q$, has a velocity, $\vec v_d$, towards the right, it will experience a downwards magnetic force, as illustrated in [](#fig:specialrelativity:current_force).
