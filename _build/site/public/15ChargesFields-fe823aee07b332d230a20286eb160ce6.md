...
:::
[Example](#ex:chargesfields:squarecircle)
...
In order to determine the bounds of the integral, think of the range in position variable that is required in order to cover the entire object. I recommend paying close attention to [Example %s](#ex:chargesfields:ring), [Example %s](#ex:chargesfields:finiteline), and [Example %s](#ex:chargesfields:squarecircle), and attempting questions which require integration on the Question Library.
:::
