...
:::{note} Solution
:class: dropdown
There are four different velocities, labeled a, b, c, d. During interval a from $t = 0$ to $t = 2$ seconds, the object moves from $x = 0$ to $x = 6$ meters, for a positive velocity in the $x$-direction of \vec{v} = 6/2 = 3 m/s$.
