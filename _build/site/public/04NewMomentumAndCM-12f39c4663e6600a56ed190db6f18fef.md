...
:::
As time progresses, the rock will be at greater and greater distances from the shore. As shown in [](#fig:momentumandcm:constvelmotionb), the rock slides 0.5 meters every second. We can define the velocity as

```{math}
:label: eq:momencumandcm:constveleq
\vec v &= \frac{\Delta x}{\Delta t} \hat x\rightarrow \frac{dx}{dt}\\
