...
:alt: A wheel rolling without slipping on the ground, with the centre of mass moving with velocity $\vec{v}_{CM}$. 
:align: center
:width: 100%
A wheel rolling without slipping on the ground, with the centre of mass moving with velocity $\vec{v}_{CM}$.
