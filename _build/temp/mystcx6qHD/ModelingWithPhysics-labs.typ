...
=== The process of science and the need for scientific writing <the-process-of-science-and-the-need-for-scientific-writing>
...
=== Guide for writing a proposal <guide-for-writing-a-proposal>
...
=== Guide for reviewing a proposal <guide-for-reviewing-a-proposal>
...
=== Guide for writing a lab report <guide-for-writing-a-lab-report>
...
==== Guide for reviewing a lab report <guide-for-reviewing-a-lab-report>
...
=== Sample proposal (Measuring g using a pendulum) <sample-proposal-measuring-g-using-a-pendulum>
...
The pendulum should be released from $9 0 degree$. When releasing the pendulum, the string should be pulled taught, and the team member's eye that is measuring the angle should be situated parallel to the measuring device.
...
Foreseeable issues in this experiment may arise when trying to find a string that is optimally inextensible, as any extensibility will cause error in the results. Additionally, being able to measure exactly $9 0 degree$ as the drop-angle for the pendulum could be difficult. In order to correct for this, the team member who is dropping the pendulum must stand directly parallel to the measuring device, minimizing parallax error.
...
Most equations are described in the theory section, but it is incorrectly assumed that the period of a pendulum is independent of the drop angle for all angles. The small angle approximation is not expected to apply with an oscillation amplitude of $9 0 degree$.
...
=== Sample lab report (Measuring g using a pendulum) <sample-lab-report-measuring-g-using-a-pendulum>

*Abstract*

In this experiment, we measured $g$ by measuring the period of a pendulum of a known length. We measured $g = 7 . 6 5 plus.minus 0 . 3 7 8 upright m \/ s^2$. This correspond to a relative difference of 22% with the accepted value ($9 . 8 upright m \/ s^2$), and our result is not consistent with the accepted value.
...
We built the pendulum with a length $L = 1 . 0 0 0 0 plus.minus 0 . 0 0 0 5 upright m$ that was measured with a ruler with $1 upright m m$ graduations (thus a negligible uncertainty in $L$). We plan to measure the period of one oscillation by measuring the time to it takes the pendulum to go through 20 oscillations and dividing that by 20. The period for one oscillation, based on our value of $L$ and the accepted value for $g$, is expected to be $T = 2 . 0 upright s$. We expect that we can measure the time for 20 oscillations with an uncertainty of $0 . 5 upright s$. We thus expect to measure one oscillation with an uncertainty of $0 . 0 2 5 upright s$ (about 1% relative uncertainty on the period). We thus expect that we should be able to measure $g$ with a relative uncertainty of the order of 1%
...
8.01
  ...
  caption: [
Results of five trials measuring a pendulum period.
],
  kind: "table",
  supplement: [Table],
) <tab:labs:exreport>

Our final measured value of $g$ is $7 . 6 5 plus.minus 0 . 3 7 8 upright m \/ s^2$. This was calculated using the mean of the values of g from the last column and the corresponding standard deviation. The relative uncertainty on our measured value of $g$ is 4.9% and the relative difference with the accepted value of $9 . 8 upright m \/ s^2$ is 22%, well above our relative uncertainty.

*Discussion and Conclusion*

In this experiment, we measured $g = 7 . 6 5 plus.minus 0 . 3 7 8 upright m \/ s^2$. This has a relative difference of 22% with the accepted value and our measured value is not consistent with the accepted value. All of our measured values were systematically lower than expected, as our measured periods were all systematically higher than the $2 . 0 upright s$ that we expected from our prediction. We also found that our measurement of $g$ had a much larger uncertainty (as determined from the spread in values that we obtained), compared to the 1% relative uncertainty that we predicted.
...
If this experiment could be redone, measuring 10 oscillations of the pendulum, rather than 20 oscillations, could provide a more precise value of $g$. Additionally, a protractor could be taped to the top of the pendulum stand, with the ruler taped to the protractor. This way, the pendulum could be dropped from a near-perfect $9 0 upright degree$ rather than a rough estimate.

=== Sample lab report review (Measuring g using a pendulum) <sample-lab-report-review-measuring-g-using-a-pendulum>

*Summary*

The authors measured the period of a pendulum to determine $g$. They measured $g$ to be $7 . 6 5 plus.minus 0 . 3 7 8 upright m \/ s^2$ which is inconsistent with the accepted value. The authors were incorrect in assuming that the pendulum would undergo simple harmonic motion in the conditions that they used.
...
The authors made a mistake in assuming that a pendulum would undergo simple harmonic motion with an amplitude of $9 0 upright degree$, as the small angle approximation used to determine the period does not apply in this case.
