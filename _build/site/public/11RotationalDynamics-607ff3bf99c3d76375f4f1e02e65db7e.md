...
**Moment of inertia:** A property of matter which describes an object's resistance to rotational motion. SI units: $\left[ \text{kgm}^2\right]$. Common variable(s): $I$.
	
**Linear mass density:** The mass per unit length of an object. SI units: $\left[\text{kg\cdot m}^{-1}\right]$. Common variable(s): $\lambda$.
:::
