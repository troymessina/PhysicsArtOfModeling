...
If more than one force is exerted on the particle, it is easy to show that the **net torque** from the net force on the particle \textbf{is equal to the sum of the torques on the particle}:
```{math}
