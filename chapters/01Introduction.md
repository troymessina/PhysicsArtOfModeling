...
We can get some insight into the Scientific Method through a simple example. ![A hand drops a tennis ball (credit:Mike Run).](figures/Introduction/tennis_ball.jpg)
