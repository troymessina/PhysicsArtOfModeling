...
:::{tip} Checkpoint
A capacitor holds $0.2 {\rm C}$ of charge when it has a potential difference of 500V between its plates. If the same capacitor holds $0.15 {\rm C}$ of charge,  what is the potential difference between its plates?
1.  $375 {\rm V}$. 
2.  $500 {\rm V}$.
3.  $75 {\rm V}$.
4.  $150 {\rm V}$.
