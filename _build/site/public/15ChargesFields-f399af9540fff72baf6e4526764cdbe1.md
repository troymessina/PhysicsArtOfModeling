...
```{math}
E_1=\left |k\frac{Q_1}{a^2}\right |=(9e9 {\rm N\cdot m^2/C^{2}})\frac{(1\times 10^{-9} {\rm C})}{(0.01 {\rm m})^2}=9e4 {\rm N/C}
```
and components:
```{math}
...
```{math}
E_2=\left |k\frac{Q_2}{a^2}\right |=(9e9 {\rm N\cdot m^2/C^{2}})\frac{(2\times 10^{-9} {\rm C})}{(0.01 {\rm m})^2}=1.8e5 {\rm N/C}
```
and components:
```{math}
