...
```{math}
\frac{\partial f}{\partial x}&=\frac{\partial}{\partial x}(ax^2+byz-\sin(z)) = 2ax\\
\frac{\partial f}{\partial y}&=\frac{\partial}{\partial y}(ax^2+byz-\sin(z)) = bz \\
\frac{\partial f}{\partial z}&=\frac{\partial}{\partial z}(ax^2+byz-\sin(z)) = by-\cos(z) 
``` 
:::
