...
:::{tip} Checkpoint
Calculate the positions of the turning points for the situation shown in [](#fig:potentialecons:springE). The total energy is \SI{25}{J} and the spring constant is $k=1 {\rm N/m}$.
:::{note} Answer
:class: dropdown
$7.1 {\rm m}$
:::
