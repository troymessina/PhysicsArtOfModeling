...
:::{note} Example 5.2
:label: ex:newtonslaws:blockI A block of mass $m$ is at rest on a inclined surface, as shown in [](#fig:newtonslaws:blockI). What forces are exerted on the block?
