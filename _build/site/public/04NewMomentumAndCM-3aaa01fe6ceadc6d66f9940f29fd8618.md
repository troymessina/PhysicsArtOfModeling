...
* During interval **b** from $t = 2$ to $t = 5$ seconds, the object moves from $x = 6$ to $x = 6$ meters, for a zero velocity (motionless) in the $x$-direction of $\vec{v} = (6-6)/(5-2) \hat{x} = (1.33, 0, 0) {\rm m/s}$.
