...
<table class="colwidths-auto table">
  <thead>
    <tr><th class="text-left head"><p></p></th></tr>
  </thead>
  <tbody>
    <tr>
		<td class="text-left" rowspan="2"><p><strong>Angular Quantities</strong></p></td>
		<td class="text-left"><p><strong>Newton's Second Law for a point particle about a given axis of rotation</strong></p></td>
	</tr>
	<tr>
		<td class="text-left"><p>$ \vec\omega = \frac{1}{r^2}\vec r \times \vec v$</p></td>
		<td class="text-left"><p>**Newton's Second Law for a point particle about a given axis of rotation**</p></td>
	</tr>
  </tbody>
</table>
