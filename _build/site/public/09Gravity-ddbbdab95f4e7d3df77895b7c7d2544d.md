...
```
Mathematically, this is equivalent to the force that we considered in [](#ex:potentialecons:gravitycons) of Chapter \ref{chapter:potentialecons}, which we showed was a conservative force. The force of gravity in Newton's theory is thus a conservative force, for which we can determine a potential energy function.
